    ...
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <div>
          ...
          <span style={{ fontSize: '12px',color:'rgba(255, 0, 0, 1)',display: !allReadingsRef.current[allReadingsRef.current.length - 1].temperatura && 'none' ,transition: 'color 0.5s ease-in-out'}}>{value => `${allReadingsRef.current[allReadingsRef.current.length - 1].temperatura ? value + '°C' : "Offline"} `}</span>
